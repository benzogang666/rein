          ...
          items: [
            {
              ...
              cookingTime: 15,
              details:
                "итальянская пицца, которая разделена на четыре части с четырьмя различными начинками, каждая из которых представляет один сезон года. Артишоки символизируют весну, помидоры или базилик символизируют лето, грибы символизируют осень, а ветчина, прошутто и оливки символизируют зимуа, которая разделена на четыре части с четырьмя различными начинками, каждая из которых представляет один сезон года. Артишоки символизируют весну, помидоры или базилик символизируют лето, грибы символизируют осень, а ветчина, прошутто и оливки символизируют зимуа, которая разделена на четыре части с четырьмя различными начинками, каждая из которых представляет один сезон года. Артишоки символизируют весну, помидоры или базилик символизируют лето, грибы символизируют осень, а ветчина, прошутто и оливки символизируют зиму",
            },
            {
              id: "pizza_bbq",
              name: "BBQ",
